...
<Note>
This is actually a POST endpoint in the implementation (located at `src/app/api/lambda/progress/route.ts`), but functions as a progress check. Poll this endpoint every few seconds to track render progress.
</Note>
